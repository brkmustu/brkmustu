...
Evde **"Storm Breaker"** adını verdiğim bir ~~**"Pardus"**~~ (**"Linux Mint"**'a geçiş yaptım) ile geliştirmeler yapıyorum. Geliştirme ortamında **"Docker"'ın** sağladığı esneklikle birçok sistem üzerinde rahat bir şekilde denemeler yapabiliyorum. Geliştirme ortamı olarak **"VS Code"** ve **"Zed"** kullanıyorum.
